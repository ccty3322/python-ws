...
# 环境变量
UUID = os.environ.get('UUID', 'f5beacee-3f20-402c-8030-a7f3c2a1a5dc')   # 节点UUID
...
DOMAIN = os.environ.get('DOMAIN', 'python-ws-65ab.onbelmo.uk')                # 项目分配的域名或反代后的域名,不包含https://前缀,例如: domain.xxx.com
SUB_PATH = os.environ.get('SUB_PATH', 'sub999')         # 节点订阅token
